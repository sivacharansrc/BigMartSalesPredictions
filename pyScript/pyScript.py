...
df_final = df_clean[['Item_Identifier', 'Item_MRP', 'Item_Outlet_Sales', 'Item_Visibility_varTransformed', 'Item_Weight_varTransformed',
                     'Outlet_Identifier', 'Outlet_Location_Type', 'Outlet_Type', 'No_Of_Years_Established_varTransformed',
                     'Item_Fat_Content_varTransformed', 'Outlet_Size_varTransformed']]
df_final = df_final.reset_index()
# SAMPLING DATA

x_train = df_final.sample(frac=0.8, random_state=1)
y_test = df_final.loc[~df_final.index.isin(x_train.index)]